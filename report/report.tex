...
\begin{titlepage}
    ...
    \textsc{\LARGE }\\[1 cm]
    \textsc{\huge {\textbf{kulliyyah of information and}}}\\[.1 cm]
    \textsc{\huge {\textbf{communication technology}}}\\[.5 cm]
    \textsc{\huge {\textbf{department of computer science}}}\\ [ 1.5 cm]
    \textsc{\large FINAL YEAR PROJECT REPORT}\\ [1 cm]
    \textsc{\Large {\textbf{sign language recognition using deep learning}}}\\ [1.5 cm]
...
\begin{titlepage}
    \center
    \textsc{\huge {\textbf{FINAL YEAR PROJECT REPORT}}}\\ [1.5 cm]
  
    \textsc{\LARGE {\textbf{sign language recognition using deep learning}}}\\ [1 cm]
...
\begin{leftitemize}
    ...
    \item[DP]        (Deep Learning) 
    \item[ReLU]      (Rectified Linear Unit)  
    \item[MC]        (Multi Channel ) 
    \item[FC]        (Fully Connected Layer) 
    \item[GCP]       (Google Cloud Platform)  
    \item[GCE]       (Google Compute Engine)  
